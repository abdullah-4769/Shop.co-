    ...
    return (
        <section className="mx-auto max-w-7xl px-4 py-12">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {product.originalPrice && (
                                    <>
                                        ...
                                        <span className="bg-red-100 px-3 rounded-full text-sm text-red-600">
            ...
            <div className="mt-8 text-center">
                <Link
                    href="/products"
                    className="inline-block rounded-full border-2 border-solid border-gray-300 px-8 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-black hover:border-transparent hover:text-white duration-500"
                >
                    View All
                </Link>
            </div>
