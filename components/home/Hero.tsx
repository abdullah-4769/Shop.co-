    ...
    <section className="w-full bg-[#F2F0F1] min-h-screen">
      <div className="flex flex-col lg:flex-row items-center max-w-[1400px] mx-auto">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 lg:px-20 py-12 lg:py-20">
          ...
          <Link
            href="/products"
            className="mt-8 px-12 py-4 border-2 border-transparent border-solid hover:bg-transparent hover:text-black duration-500 hover:border-black hover:border-2 bg-black text-white rounded-full font-medium hover:bg-gray-900 transition-colors w-fit text-base"
          >
            Shop Now
          </Link>
        ...
        <div className="relative w-full lg:w-[50%] h-[500px] lg:h-screen">
          ...
          <div className="absolute bottom-1/3 left-8">
            <StarIcon className="w-8 h-8 animate-bounce" />
          </div>
        </div>
      </div>
    </section>
